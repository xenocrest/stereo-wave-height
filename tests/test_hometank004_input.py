...
class HomeTank004InputInspectionTests(unittest.TestCase):
    def test_input_remains_registered_and_failed_calibration_is_not_approved(self):
        ...
        expected = {
            ...
            "single_frame_backend_validation.yaml", "single_frame_backend_validation.md",
            "frame_level_synchronization.yaml", "frame_level_synchronization.md",
            "sync_tolerance_policy.yaml", "sync_tolerance_validation.yaml", "sync_tolerance_validation.md",
            "single_frame_static_result.yaml", "single_frame_static_report.md",
            ...
            "adaptive_calibration_reanalysis.yaml",
