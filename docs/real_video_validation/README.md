...
`HomeTank_003` is `NOT_CAPTURED / PENDING`. Its repository templates and short capture checklist are under [experiments/real_video/HomeTank_003](../../experiments/real_video/HomeTank_003/). No synthetic test result is represented as real experimental evidence.
